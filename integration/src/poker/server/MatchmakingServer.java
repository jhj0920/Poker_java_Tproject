...
/**
 * MatchmakingServer is a simple matchmaking server that allows clients to create or join parties.
 * It listens for client connections and handles matchmaking logic.
 */
