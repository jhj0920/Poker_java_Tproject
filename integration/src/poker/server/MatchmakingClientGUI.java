...
/**
 * MatchmakingClientGUI is a simple GUI client for a matchmaking server.
 * It allows users to create or join parties and displays messages from the server.
 */
public class MatchmakingClientGUI extends JFrame {
	 ...
	 * It initializes input and output streams for communication and starts a thread to listen for messages from the server.
	 *
